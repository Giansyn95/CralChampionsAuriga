/*
 * CRAL Champions Admin - mobile/iOS stability v39
 *
 * Strategia v39:
...
(() => {
  ...
  const REENTRY_KEY = 'cral-admin-mobile-v39-reentry';
  ...
  function settleAdmin() {
    ...
    run();
    [50, 120, 250, 450, 750, 1100, 1600, 2300].forEach(ms => {
    ...
    // Dopo l'assestamento, se la pagina e' davvero tornata a scala 1 possiamo
    // riabilitare il pinch. Se Safari conserva una scala anomala, lasciamo il
    // viewport bloccato e il contro-zoom attivo invece di mostrare una UI tagliata.
